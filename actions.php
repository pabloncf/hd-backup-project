...
$result_agendamentos = "INSERT INTO agendamentos (id_agd, ticket_agd, oldserver_agd, newserver_agd, observation_agd, created_agd, modified_agd, agd_id_reason, agd_name_status) VALUES ('','$ticket','$oldServer','$newServer','$observation',NOW(),NOW(),'$reason','$status')";
